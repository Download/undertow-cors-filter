...
## Download
The module zip file can be downloaded directly from Maven Central: [undertow-cors-filter-0.2.0-bin.zip](https://repo1.maven.org/maven2/com/stijndewitt/undertow/cors/undertow-cors-filter/0.2.0/undertow-cors-filter-0.2.0-bin.zip).
...
in your WildFly / EAP installation folder containing a JAR file `undertow-cors-filter-0.2.0.jar` and a 
...
<module xmlns="urn:jboss:module:1.0" name="com.stijndewitt.undertow.cors">
  <resources>
    <resource-root path="undertow-cors-filter-0.2.0.jar"/>
  </resources>
  <dependencies>
